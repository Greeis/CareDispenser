...
int unsigned espera1 = 0;         //contagens do tempo de habilitacao das portas
...
//----------------------------------------------Quando o horario do alarme é atingido
  ...
  /*
    Delay(1000) é  um segundo.
    Um minuto é x 60
    29 minutos é  60 x 29 = 1800
    
  */
  
  if(HORA != ALARM1 && FLAG[4] == 's')   //------------ Cancela alarme 1 apos UM minuto
  {
    espera1++;                                                      //contar 29 minutos
    delay(1000); ///conta 1 segundo
    Serial.println("Entrou no tempo de espera");
    if(espera1 == 120)  //só esta contando 3 minutos. Alterar para 1800 para 29 minutos
    {
  ...
  {
    espera2++;                                                //contar 30 minutos
    delay(1000);
    if(espera2 == 120)  //só esta contando 2 minutos. Alterar para 1800 para 30 minutos
    {
  ...
  if(HORA != RECARGA && FLAG[2] == 's') //----------------------------- Cancela recarga
  {
    esperaR++;
    delay(1000);
    if (esperaR == 120) //só esta contando 2 minutos. Alterar para 1800 para 30 minutos
    {
